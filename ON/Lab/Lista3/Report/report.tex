...
\subsection*{Rozwiązanie dla funkcji $f_{1}(x) = e^{1-x} - 1$}
\begin{itemize}
...
\begin{figure}[H] 
    ...
    \includegraphics[width=0.7\textwidth, keepaspectratio]{../Examples/funkcja62.png}
...
\subsection*{Co się stanie jeśli w $f_{1}$ wybierzemy $x_0 \in (1, \infty)$ w metodzie Newtona?}
...
\subsection*{Co się stanie jeśli w $f_{2}$ wybierzemy $x_0 > 1$ w metodzie Newtona?}
