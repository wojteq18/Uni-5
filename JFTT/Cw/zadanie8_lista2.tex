...
\end{center}
Chcemy udowodnić, że jeżeli języki $L_1 i L_2$ są regularne, to język $L_1 \setminus L_2$ (rozumiany jako różnica zbiorów) też jest regularny. \\
Podstawą naszego dowodu będzie tożsamość z teorii zbiorów: $L_1 \setminus L_2 = L_1 \cap \overline{L_2}$, gdzie $\overline{L_2}$ oznacza dopełnienie języka $L_2$,
